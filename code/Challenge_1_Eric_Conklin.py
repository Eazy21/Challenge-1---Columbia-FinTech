...
total_loan_value = sum(loan_costs)
print(f"The total loan value is ${total_loan_value}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan_amount = total_loan_value/number_of_loans
...
print(f"There are {remaining_months} remaining months on the loan")
...
if present_value >= loan_price:
    print(f"The loan is worth the cost to buy it")
else:
    print(f"The loan is too expensive.  Do not buy")
...
for dict in loans:
    loan_price = dict.get("loan_price")
    if loan_price <= 500:
